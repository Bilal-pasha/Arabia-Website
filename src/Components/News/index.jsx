...
export default function NewsSection() {
  return (
    <section className="py-20 px-32">
      <div className="text-center space-y-12 px-[100px]">
        ...
        <p className="px-32">
          ...
          knowledge. At Jamia Arabia Islamia, we are not just an institution; we
          are a timeless journey of discovery, enlightenment, and
          transformation.
        </p>
